...
export default function Page() {
  ...
  const contractId = pathname ? pathNames[pathNames.length - 1] : null;
  ...
  useEffect(() => {
    ...
    const fetchContract = async () => {
      const endpoint = "/api/contractPayment?id=" + contractId;
      const options = {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleSubmit = async (event: any) => {
    ...
    router.push("/contractPayment/" + contractId);
  };
      ...
      <div className="relative min-h-screen flex items-start justify-center overflow-x-hidden">
        <div className="container pt-24 max-w-7xl mx-auto w-full">
          <div className="gap-6 flex flex-col justify-start lg:justify-center items-center lg:items-start dark:text-white">
            ...
            >
              Edit Contract Payment
            </LargeHeading>
            <Card className="border-black dark:border-white">
              <CardHeader>
                <CardTitle>Edit the details of the contract</CardTitle>
              </CardHeader>
              <CardContent>
