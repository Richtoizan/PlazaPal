      ...
      <div className="container pt-24 max-w-7xl mx-auto w-full">
        <div className="gap-6 flex flex-col justify-start lg:justify-center items-center lg:items-start dark:text-white">
          ...
          <Card className="border-black dark:border-white">
            <CardHeader>
              <CardTitle>Enter the details of the new Shop Owner</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid w-full items-center gap-4">
                  ...
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={handleSaveChange}
                      placeholder="Surname of the Shop Owner"
                    />
                  </div>
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={handleSaveChange}
                      placeholder="Email of the Shop Owner"
                    />
                  </div>
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={handleSaveChange}
                      placeholder="Telephone Number of the Shop Owner"
                    />
                  </div>
