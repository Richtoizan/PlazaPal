...
export default function Page() {
  ...
  const branchId = pathname ? pathNames[pathNames.length - 1] : null;
  ...
  useEffect(() => {
    ...
    const fetchBranch = async () => {
      const endpoint = "/api/branch?id=" + branchId;
      const options = {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
      ...
      setSaveBranch(result);
      setDate(new Date(result.dateOpened)); // set the date state
    };
        ...
        <div className="container pt-24 max-w-7xl mx-auto w-full">
          <div className="gap-6 flex flex-col justify-start lg:justify-center items-center lg:items-start dark:text-white">
            ...
            <Card className="border-black dark:border-white">
              <CardHeader>
                <CardTitle>Edit the details of the branch</CardTitle>
              </CardHeader>
              <CardContent>
